...
_RPBRESETBUCKETTYPEREQ = _descriptor.Descriptor(
  name='RpbResetBucketTypeReq',
  full_name='RpbResetBucketTypeReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='RpbResetBucketTypeReq.type', index=0,
      number=1, type=12, cpp_type=9, label=2,
      has_default_value=False, default_value="",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['RpbResetBucketTypeReq'] = _RPBRESETBUCKETTYPEREQ
...
class RpbResetBucketTypeReq(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _RPBRESETBUCKETTYPEREQ

  # @@protoc_insertion_point(class_scope:RpbResetBucketTypeReq)
